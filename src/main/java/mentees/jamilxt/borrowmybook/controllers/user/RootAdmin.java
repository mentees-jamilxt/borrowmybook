...
public class RootAdmin {
    ...
    public String viewUserListPage(Model model) {
        ...
        return "backendusers/rootadmin/user-list";
    }
    ...
    public String addNewUserForm(Model model) {
        ...
        return "backendusers/rootadmin/user-new-form";
    }
    ...
    public String processNewUserForm(@Valid @ModelAttribute("user") User user,
        ...
        return "redirect:/root-admin/list";
    }
    ...
    public String editUserForm(@PathVariable Integer id, Model model) {
        ...
        model.addAttribute("listRoles", listRoles);
        return "backendusers/rootadmin/user-update-form";
    }
