package mentees.jamilxt.borrowmybook.controllers.user;


import mentees.jamilxt.borrowmybook.entity.Role;
import mentees.jamilxt.borrowmybook.entity.User;
import mentees.jamilxt.borrowmybook.helper.FileUploadUtil;
...
public class SiteAdmin {
    ...
    public String viewUserListPage(Model model) {
        ...
        return "backendusers/siteadmin/user-list";
    }
    ...
    public String processNewUserForm(@Valid @ModelAttribute("user") User user,
        ...
        if (!multipartFile.isEmpty()) {
            ...
            user.getRootAdmin().setUser(user);
            userService.saveUser(user);
        }
        return "redirect:/site-admin/list";
    }
    ...
    public String editUserForm(@PathVariable Integer id, Model model) {
        ...
        model.addAttribute("listRoles", listRoles);
        return "backendusers/siteadmin/user-update-form";
    }
